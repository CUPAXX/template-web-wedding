      ...
      <div id={"section4"} className="h-screen flex flex-col py-10" style={{backgroundColor: "#e6f2ff"}}>
        <div className='flex flex-col gap-4 px-10 md:px-48'>
          ...
          <div className="flex w-full justify-center">
            <div onClick={e => openInNewTab("https://goo.gl/maps/b1CCSLFy2uMwDJ8HA")} className='cursor-pointer w-60 text-center bg-white py-4 px-6 md:px-8 md:py-4 rounded-full mt-3 animate-bounce text-purple-400 text-xs md:text-sm'>
              Buka di Google Maps
            </div>
          </div>
        </div>
